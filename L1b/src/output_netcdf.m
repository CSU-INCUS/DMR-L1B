...
nccreate(output_file,"/CalibrationData/NEDTwl","Dimensions",{"Ncal",length(cal.NEDTwl.data),"ch",5},"Format","netcdf4")
...
nccreate(output_file,"/CalibrationData/NEDTcs","Dimensions",{"Ncal",length(cal.NEDTcs.data),"ch",5},"Format","netcdf4")
